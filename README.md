...
```bash
dotnet add package MccTaxonomy
```
...
IEnumerable<string> codes = MccLookup.GetCodes(MccCategory.Airlines);

// As integers
IEnumerable<int> codes = MccLookup.GetCodeValues(MccCategory.Airlines);

// Total codes in taxonomy
Console.WriteLine(MccLookup.Count);
```

### Human-readable category description

```csharp
string desc = MccCategory.Supermarkets.GetDescription();
// => "Grocery Stores and Supermarkets"
```

### Custom / override codes

If your use case includes MCC codes not covered by the built-in taxonomy, or you need to reclassify an existing code:
...
| GeneralServices | General and Professional Services              | 7210, 7299, 8111      |
| OfficeSupplies  | Office and Stationery Supplies                 | 5943                  |
...
<details>
<summary>Click to expand complete list of 914 Merchant Category Codes from the [official Citi guide](https://www.citibank.com/tts/solutions/commercial-cards/assets/docs/govt/Merchant-Category-Codes.pdf)</summary>
...
| 3787 | Caribe Royal Resort Suite and Villas |
...
Every fintech that processes card transactions needs MCC categorization. This package gives you a single dependency-free lookup that covers the standard codes used in European and global card networks.
